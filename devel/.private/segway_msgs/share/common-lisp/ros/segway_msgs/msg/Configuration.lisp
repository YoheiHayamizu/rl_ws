...
(cl:defclass <Configuration> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (omni_yaw_correction_factor
    :reader omni_yaw_correction_factor
    :initarg :omni_yaw_correction_factor
    :type cl:float
    :initform 0.0)
   (omni_straffe_correction_factor
    :reader omni_straffe_correction_factor
    :initarg :omni_straffe_correction_factor
    :type cl:float
    :initform 0.0)
   (wheel_track_width_m
...
(cl:ensure-generic-function 'omni_yaw_correction_factor-val :lambda-list '(m))
(cl:defmethod omni_yaw_correction_factor-val ((m <Configuration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segway_msgs-msg:omni_yaw_correction_factor-val is deprecated.  Use segway_msgs-msg:omni_yaw_correction_factor instead.")
  (omni_yaw_correction_factor m))

(cl:ensure-generic-function 'omni_straffe_correction_factor-val :lambda-list '(m))
(cl:defmethod omni_straffe_correction_factor-val ((m <Configuration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader segway_msgs-msg:omni_straffe_correction_factor-val is deprecated.  Use segway_msgs-msg:omni_straffe_correction_factor instead.")
  (omni_straffe_correction_factor m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Configuration>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'wheelbase_length_m))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'omni_yaw_correction_factor))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'omni_straffe_correction_factor))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Configuration>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'omni_yaw_correction_factor) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'omni_straffe_correction_factor) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Configuration>)))
  ...
  "03157f9e1c3a782af2e296a4e475e4af")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Configuration)))
  "Returns md5sum for a message object of type 'Configuration"
  "03157f9e1c3a782af2e296a4e475e4af")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Configuration>))
  ...
  (cl:list 'Configuration
    ...
    (cl:cons ':omni_yaw_correction_factor (omni_yaw_correction_factor msg))
    (cl:cons ':omni_straffe_correction_factor (omni_straffe_correction_factor msg))
