...
if(bwi_mapper_CONFIG_INCLUDED)
  return()
endif()
set(bwi_mapper_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(bwi_mapper_SOURCE_PREFIX /home/yohei/rl_ws/src/bwi_common/bwi_mapper)
  set(bwi_mapper_DEVEL_PREFIX /home/yohei/rl_ws/devel/.private/bwi_mapper)
  set(bwi_mapper_INSTALL_PREFIX "")
  set(bwi_mapper_PREFIX ${bwi_mapper_DEVEL_PREFIX})
else()
  set(bwi_mapper_SOURCE_PREFIX "")
  set(bwi_mapper_DEVEL_PREFIX "")
  set(bwi_mapper_INSTALL_PREFIX /home/yohei/rl_ws/install)
  set(bwi_mapper_PREFIX ${bwi_mapper_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'bwi_mapper' is deprecated")
...
set(bwi_mapper_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/yohei/rl_ws/src/bwi_common/bwi_mapper/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(bwi_mapper_INCLUDE_DIRS "")
  set(_include_dirs "/home/yohei/rl_ws/src/bwi_common/bwi_mapper/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yohei/rl_ws/devel/.private/bwi_mapper/lib;/home/yohei/rl_ws/devel/lib;/home/yohei/segbot_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(bwi_mapper_LIBRARY_DIRS ${lib_path})
      list(APPEND bwi_mapper_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'bwi_mapper'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND bwi_mapper_LIBRARIES ${lib})
    endif()
  endif()
...
set(bwi_mapper_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${bwi_mapper_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "map_server;nav_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 bwi_mapper_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${bwi_mapper_dep}_FOUND)
      find_package(${bwi_mapper_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bwi_mapper_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(bwi_mapper_INCLUDE_DIRS ${${bwi_mapper_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(bwi_mapper_LIBRARIES ${bwi_mapper_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${bwi_mapper_dep}_LIBRARIES})
  _list_append_deduplicate(bwi_mapper_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(bwi_mapper_LIBRARIES ${bwi_mapper_LIBRARIES})

  _list_append_unique(bwi_mapper_LIBRARY_DIRS ${${bwi_mapper_dep}_LIBRARY_DIRS})
  list(APPEND bwi_mapper_EXPORTED_TARGETS ${${bwi_mapper_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${bwi_mapper_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
