...
if("TRUE" STREQUAL "TRUE")
  set(bwi_gazebo_entities_SOURCE_PREFIX /home/yohei/rl_ws/src/bwi_common/bwi_gazebo_entities)
  set(bwi_gazebo_entities_DEVEL_PREFIX /home/yohei/rl_ws/devel/.private/bwi_gazebo_entities)
  ...
  set(bwi_gazebo_entities_INSTALL_PREFIX /home/yohei/rl_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/bwi_gazebo_entities " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/bwi_gazebo_entities' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bwi_gazebo_entities' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'bwi_gazebo_entities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yohei/rl_ws/src/bwi_common/bwi_gazebo_entities/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yohei/rl_ws/devel/.private/bwi_gazebo_entities/lib;/home/yohei/rl_ws/devel/lib;/home/yohei/segbot_ws/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bwi_gazebo_entities_dep}_FOUND)
      find_package(${bwi_gazebo_entities_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bwi_gazebo_entities_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
