...
"""autogenerated by genpy from bwi_msgs/TriggerRequest.msg. Do not edit."""
import sys
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bwi_msgs/TriggerResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TriggerResponse(genpy.Message):
  ...
  _type = "bwi_msgs/TriggerResponse"
  _has_header = False #flag to mark the presence of a Header object
