...
"""autogenerated by genpy from bwi_msgs/ImageQuestionRequest.msg. Do not edit."""
import sys
...
class ImageQuestionRequest(genpy.Message):
  _md5sum = "befbb4e71533b512f57c0aecad466f7f"
  _type = "bwi_msgs/ImageQuestionRequest"
...
float64 w
"""
  __slots__ = ['image','point_cloud','pose','timeout','question']
  _slot_types = ['sensor_msgs/Image','sensor_msgs/PointCloud2','geometry_msgs/Pose','int64','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       image,point_cloud,pose,timeout,question
    ...
    """
    if args or kwds:
      super(ImageQuestionRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B7dq().pack(_x.point_cloud.is_dense, _x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.timeout))
      _x = self.question
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.point_cloud.is_dense, _x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.timeout,) = _get_struct_B7dq().unpack(str[start:end])
...
def _get_struct_BI():
    ...
    return _struct_BI
_struct_B7dq = None
def _get_struct_B7dq():
    global _struct_B7dq
    if _struct_B7dq is None:
        _struct_B7dq = struct.Struct("<B7dq")
    return _struct_B7dq
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
...
def _get_struct_2I():
    ...
    return _struct_2I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bwi_msgs/ImageQuestionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ImageQuestionResponse(genpy.Message):
  _md5sum = "40010323bce4291465206eb424c88b57"
  _type = "bwi_msgs/ImageQuestionResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int32 SUCCESSFUL_ANSWER=0
int32 TIMEOUT=1
int32 CANCELLED=2
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageQuestionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_i().pack(self.end_reason))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.end_reason,) = _get_struct_i().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
def _get_struct_i():
    ...
    return _struct_i
class ImageQuestion(object):
  _type          = 'bwi_msgs/ImageQuestion'
  _md5sum = '57c2d8b25cad32762a1bf1f70c8a327b'
  _request_class  = ImageQuestionRequest
  _response_class = ImageQuestionResponse
