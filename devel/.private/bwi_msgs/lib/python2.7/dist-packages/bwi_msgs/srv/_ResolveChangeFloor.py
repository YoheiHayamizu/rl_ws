...
"""autogenerated by genpy from bwi_msgs/ResolveChangeFloorRequest.msg. Do not edit."""
import sys
...
class ResolveChangeFloorRequest(genpy.Message):
  _md5sum = "772ff4012bb9fe3f3b88e0eae51cb09a"
  _type = "bwi_msgs/ResolveChangeFloorRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string new_room
string facing_door
"""
  __slots__ = ['new_room','facing_door']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ResolveChangeFloorRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.new_room is None:
        self.new_room = ''
      if self.facing_door is None:
        self.facing_door = ''
    else:
      self.new_room = ''
      self.facing_door = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.new_room = str[start:end].decode('utf-8')
      else:
        self.new_room = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.facing_door = str[start:end].decode('utf-8')
      else:
        self.facing_door = str[start:end]
      return self
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bwi_msgs/ResolveChangeFloorResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ResolveChangeFloorResponse(genpy.Message):
  _md5sum = "fd748bf9eec6b1b18bfa80fe9bc3674a"
  _type = "bwi_msgs/ResolveChangeFloorResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string floor_name
...
float64 w
"""
  __slots__ = ['floor_name','pose','success','error_message']
  _slot_types = ['string','geometry_msgs/PoseWithCovarianceStamped','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       floor_name,pose,success,error_message
    ...
    """
    if args or kwds:
      super(ResolveChangeFloorResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class ResolveChangeFloor(object):
  _type          = 'bwi_msgs/ResolveChangeFloor'
  _md5sum = 'd565d7d5ff83ae40abf53092bf5912c5'
  _request_class  = ResolveChangeFloorRequest
  _response_class = ResolveChangeFloorResponse
