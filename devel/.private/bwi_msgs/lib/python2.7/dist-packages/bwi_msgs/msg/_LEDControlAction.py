...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B2i3I().pack(_x.action_goal.goal.type.led_animations, _x.action_goal.goal.timeout.secs, _x.action_goal.goal.timeout.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.action_feedback.feedback.time_running.secs, _x.action_feedback.feedback.time_running.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.type.led_animations, _x.action_goal.goal.timeout.secs, _x.action_goal.goal.timeout.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B2i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.time_running.secs, _x.action_feedback.feedback.time_running.nsecs,) = _get_struct_2i().unpack(str[start:end])
      return self
