...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.time_running.secs, _x.time_running.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_running.secs, _x.time_running.nsecs,) = _get_struct_2i().unpack(str[start:end])
