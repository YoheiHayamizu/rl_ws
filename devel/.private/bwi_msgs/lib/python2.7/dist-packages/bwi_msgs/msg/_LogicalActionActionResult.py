...
"""autogenerated by genpy from bwi_msgs/LogicalActionActionResult.msg. Do not edit."""
import sys
...
class LogicalActionActionResult(genpy.Message):
  _md5sum = "8a3d7105bebb3934bd7276c4289e941d"
  _type = "bwi_msgs/LogicalActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','bwi_msgs/LogicalActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LogicalActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = bwi_msgs.msg.LogicalActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = bwi_msgs.msg.LogicalActionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.observations)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.observations:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.observations.append(val1)
      return self
