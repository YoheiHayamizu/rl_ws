...
"""autogenerated by genpy from bwi_msgs/LEDControlActionResult.msg. Do not edit."""
import sys
...
class LEDControlActionResult(genpy.Message):
  _md5sum = "c049f9d0333c748f4f78b83ea30fb01f"
  _type = "bwi_msgs/LEDControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','bwi_msgs/LEDControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LEDControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = bwi_msgs.msg.LEDControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = bwi_msgs.msg.LEDControlResult()
