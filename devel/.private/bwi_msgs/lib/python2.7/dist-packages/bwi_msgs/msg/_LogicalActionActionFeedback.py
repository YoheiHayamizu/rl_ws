...
"""autogenerated by genpy from bwi_msgs/LogicalActionActionFeedback.msg. Do not edit."""
import sys
...
class LogicalActionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "bwi_msgs/LogicalActionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','bwi_msgs/LogicalActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LogicalActionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = bwi_msgs.msg.LogicalActionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = bwi_msgs.msg.LogicalActionFeedback()
