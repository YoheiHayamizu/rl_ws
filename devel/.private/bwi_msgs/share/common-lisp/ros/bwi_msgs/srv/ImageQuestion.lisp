...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImageQuestion-request>)))
  ...
  "57c2d8b25cad32762a1bf1f70c8a327b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImageQuestion-request)))
  "Returns md5sum for a message object of type 'ImageQuestion-request"
  "57c2d8b25cad32762a1bf1f70c8a327b")
...
(cl:ensure-generic-function 'end_reason-val :lambda-list '(m))
(cl:defmethod end_reason-val ((m <ImageQuestion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bwi_msgs-srv:end_reason-val is deprecated.  Use bwi_msgs-srv:end_reason instead.")
  (end_reason m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ImageQuestion-response>)))
    "Constants for message type '<ImageQuestion-response>"
  '((:SUCCESSFUL_ANSWER . 0)
    (:TIMEOUT . 1)
    (:CANCELLED . 2))
)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ImageQuestion-response>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'end_reason)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageQuestion-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'answers)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'end_reason) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImageQuestion-response>)))
  ...
  (cl:format cl:nil "int32 SUCCESSFUL_ANSWER=0~%int32 TIMEOUT=1~%int32 CANCELLED=2~%~%string[] answers~%int32 end_reason~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImageQuestion-response)))
  "Returns full string definition for message of type 'ImageQuestion-response"
  (cl:format cl:nil "int32 SUCCESSFUL_ANSWER=0~%int32 TIMEOUT=1~%int32 CANCELLED=2~%~%string[] answers~%int32 end_reason~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ImageQuestion-response>))
  ...
  (cl:list 'ImageQuestion-response
    ...
    (cl:cons ':end_reason (end_reason msg))
))
