...
let LEDControlGoal = require('./LEDControlGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class LEDControlActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LEDControlGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LEDControlActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LEDControlGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LEDControlGoal()
    }
...
module.exports = LEDControlActionGoal;
