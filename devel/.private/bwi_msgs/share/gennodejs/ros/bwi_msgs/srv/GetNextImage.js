...
class GetNextImageRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetNextImageRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetNextImageRequest
    let len;
    let data = new GetNextImageRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetNextImageRequest(null);
    return resolved;
    }
};
...
class GetNextImageResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetNextImageResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetNextImageResponse
    let len;
    let data = new GetNextImageResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetNextImageResponse(null);
...
module.exports = {
  Request: GetNextImageRequest,
  Response: GetNextImageResponse,
  md5sum() { return '060ebf3a330350842f7587d9759a9de4'; },
  datatype() { return 'bwi_msgs/GetNextImage'; }
};
