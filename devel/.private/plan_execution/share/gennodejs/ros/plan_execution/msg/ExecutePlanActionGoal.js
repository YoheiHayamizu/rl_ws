...
let ExecutePlanGoal = require('./ExecutePlanGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ExecutePlanActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecutePlanGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExecutePlanGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecutePlanActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ExecutePlanGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ExecutePlanGoal()
    }
...
module.exports = ExecutePlanActionGoal;
