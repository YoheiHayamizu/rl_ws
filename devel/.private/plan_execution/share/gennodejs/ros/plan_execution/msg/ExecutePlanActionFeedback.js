...
let ExecutePlanFeedback = require('./ExecutePlanFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ExecutePlanActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ExecutePlanFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecutePlanFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecutePlanActionFeedback(null);
    ...
    data.feedback = ExecutePlanFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecutePlanActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExecutePlanFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExecutePlanFeedback()
    }
...
module.exports = ExecutePlanActionFeedback;
