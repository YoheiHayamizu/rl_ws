...
struct CurrentStateQueryRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::plan_execution::AspRule_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::plan_execution::AspRule_<ContainerAllocator> >::other >  _query_type;
  _query_type query;
