...
"""autogenerated by genpy from plan_execution/UpdateFluentsRequest.msg. Do not edit."""
import sys
...
class UpdateFluentsRequest(genpy.Message):
  ...
  _type = "plan_execution/UpdateFluentsRequest"
...
"""
  __slots__ = ['fluents']
  _slot_types = ['plan_execution/AspFluent[]']
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from plan_execution/UpdateFluentsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class UpdateFluentsResponse(genpy.Message):
  ...
  _type = "plan_execution/UpdateFluentsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.consistent))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
...
class UpdateFluents(object):
  _type          = 'plan_execution/UpdateFluents'
