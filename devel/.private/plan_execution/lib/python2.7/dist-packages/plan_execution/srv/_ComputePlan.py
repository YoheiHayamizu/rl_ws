...
"""autogenerated by genpy from plan_execution/ComputePlanRequest.msg. Do not edit."""
import sys
...
class ComputePlanRequest(genpy.Message):
  _md5sum = "9b55d8ef52d6fee225414e9d23b3ecc6"
  _type = "plan_execution/ComputePlanRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ComputePlanRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from plan_execution/ComputePlanResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ComputePlanResponse(genpy.Message):
  _md5sum = "8b9fcf0ed6bb243d982b30ef1810ab49"
  _type = "plan_execution/ComputePlanResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ComputePlanResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.plan is None:
        self.plan = plan_execution.msg.AnswerSet()
    else:
      self.plan = plan_execution.msg.AnswerSet()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.plan.satisfied))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.plan.satisfied,) = _get_struct_B().unpack(str[start:end])
...
class ComputePlan(object):
  _type          = 'plan_execution/ComputePlan'
  _md5sum = '48a67fad1628d583e4c1c2c356347c33'
  _request_class  = ComputePlanRequest
  _response_class = ComputePlanResponse
