...
"""autogenerated by genpy from plan_execution/IsPlanValidRequest.msg. Do not edit."""
import sys
...
class IsPlanValidRequest(genpy.Message):
  ...
  _type = "plan_execution/IsPlanValidRequest"
...
"""
  __slots__ = ['plan','goal']
  _slot_types = ['plan_execution/AnswerSet','plan_execution/AspRule[]']
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from plan_execution/IsPlanValidResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class IsPlanValidResponse(genpy.Message):
  ...
  _type = "plan_execution/IsPlanValidResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class IsPlanValid(object):
  _type          = 'plan_execution/IsPlanValid'
