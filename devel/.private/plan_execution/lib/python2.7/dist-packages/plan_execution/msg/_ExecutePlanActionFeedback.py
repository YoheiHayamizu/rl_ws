...
"""autogenerated by genpy from plan_execution/ExecutePlanActionFeedback.msg. Do not edit."""
import sys
...
class ExecutePlanActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "plan_execution/ExecutePlanActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','plan_execution/ExecutePlanFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecutePlanActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = plan_execution.msg.ExecutePlanFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = plan_execution.msg.ExecutePlanFeedback()
