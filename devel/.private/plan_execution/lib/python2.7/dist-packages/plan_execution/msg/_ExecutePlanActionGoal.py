...
"""autogenerated by genpy from plan_execution/ExecutePlanActionGoal.msg. Do not edit."""
import sys
...
class ExecutePlanActionGoal(genpy.Message):
  ...
  _type = "plan_execution/ExecutePlanActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','plan_execution/ExecutePlanGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = plan_execution.msg.ExecutePlanGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = plan_execution.msg.ExecutePlanGoal()
