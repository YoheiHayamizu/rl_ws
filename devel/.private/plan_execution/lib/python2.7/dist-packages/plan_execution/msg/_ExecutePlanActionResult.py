...
"""autogenerated by genpy from plan_execution/ExecutePlanActionResult.msg. Do not edit."""
import sys
...
class ExecutePlanActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "plan_execution/ExecutePlanActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','plan_execution/ExecutePlanResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecutePlanActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = plan_execution.msg.ExecutePlanResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = plan_execution.msg.ExecutePlanResult()
