...
"""autogenerated by genpy from plan_execution/AnswerSet.msg. Do not edit."""
import sys
...
class AnswerSet(genpy.Message):
  ...
  _type = "plan_execution/AnswerSet"
...
"""
  ...
  _slot_types = ['plan_execution/AspFluent[]','bool']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.satisfied))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.satisfied,) = _get_struct_B().unpack(str[start:end])
