...
struct DetectHorizontalPlanesResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::sensor_msgs::PointCloud2_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::other >  _horizontal_planes_type;
  _horizontal_planes_type horizontal_planes;

   typedef std::vector< ::geometry_msgs::Quaternion_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Quaternion_<ContainerAllocator> >::other >  _horizontal_plane_coefs_type;
  _horizontal_plane_coefs_type horizontal_plane_coefs;

   typedef std::vector< ::visualization_msgs::Marker_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::visualization_msgs::Marker_<ContainerAllocator> >::other >  _horizontal_plane_bounding_boxes_type;
...
struct MD5Sum< ::bwi_perception::DetectHorizontalPlanesResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc8a5dc21d7ec7929ULL;
  static const uint64_t static_value2 = 0xee3237b3ee3a60b1ULL;
};
...
struct Printer< ::bwi_perception::DetectHorizontalPlanesResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::bwi_perception::DetectHorizontalPlanesResponse_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.horizontal_plane_coefs.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::geometry_msgs::Quaternion_<ContainerAllocator> >::stream(s, indent + "    ", v.horizontal_plane_coefs[i]);
    }
