...
struct ExtractTabletopSceneResponse_
{
  ...
  _cloud_plane_coef_type cloud_plane_coef;
   ...
   typedef std::vector< ::sensor_msgs::PointCloud2_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::other >  _cloud_clusters_type;
