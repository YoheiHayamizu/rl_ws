...
class MoveitWaypointRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveitWaypointRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveitWaypointRequest
    let len;
    let data = new MoveitWaypointRequest(null);
  ...
  static datatype() {
    ...
    return 'bwi_moveit_utils/MoveitWaypointRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a069df9586e6cf473c489172408f6891';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveitWaypointRequest(null);
...
class MoveitWaypointResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveitWaypointResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveitWaypointResponse
    let len;
    let data = new MoveitWaypointResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveitWaypointResponse(null);
...
module.exports = {
  Request: MoveitWaypointRequest,
  Response: MoveitWaypointResponse,
  md5sum() { return 'f8932f0bdb65419ee0fbaf236c79a04f'; },
  datatype() { return 'bwi_moveit_utils/MoveitWaypoint'; }
};
