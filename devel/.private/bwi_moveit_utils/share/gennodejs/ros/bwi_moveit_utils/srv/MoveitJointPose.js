...
class MoveitJointPoseRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveitJointPoseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveitJointPoseRequest
    let len;
    let data = new MoveitJointPoseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveitJointPoseRequest(null);
...
class MoveitJointPoseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveitJointPoseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveitJointPoseResponse
    let len;
    let data = new MoveitJointPoseResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveitJointPoseResponse(null);
...
module.exports = {
  Request: MoveitJointPoseRequest,
  Response: MoveitJointPoseResponse,
  md5sum() { return '63f4641487b3d9ad59149152e0942f80'; },
  datatype() { return 'bwi_moveit_utils/MoveitJointPose'; }
};
