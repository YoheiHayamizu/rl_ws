...
;//! \htmlinclude MoveitWaypoint-request.msg.html

(cl:defclass <MoveitWaypoint-request> (roslisp-msg-protocol:ros-message)
  ((waypoints
    :reader waypoints
    :initarg :waypoints
...
(cl:defclass MoveitWaypoint-request (<MoveitWaypoint-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MoveitWaypoint-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MoveitWaypoint-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bwi_moveit_utils-srv:<MoveitWaypoint-request> is deprecated: use bwi_moveit_utils-srv:MoveitWaypoint-request instead.")))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <MoveitWaypoint-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bwi_moveit_utils-srv:waypoints-val is deprecated.  Use bwi_moveit_utils-srv:waypoints instead.")
  (waypoints m))

(cl:ensure-generic-function 'collision_objects-val :lambda-list '(m))
(cl:defmethod collision_objects-val ((m <MoveitWaypoint-request>))
...
(cl:defmethod constraints-val ((m <MoveitWaypoint-request>))
  ...
  (constraints m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MoveitWaypoint-request>) ostream)
  "Serializes a message object of type '<MoveitWaypoint-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MoveitWaypoint-request>) istream)
  "Deserializes a message object of type '<MoveitWaypoint-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MoveitWaypoint-request>))
  "Converts a ROS message object to a list"
  (cl:list 'MoveitWaypoint-request
    (cl:cons ':waypoints (waypoints msg))
    (cl:cons ':collision_objects (collision_objects msg))
    (cl:cons ':constraints (constraints msg))
))
;//! \htmlinclude MoveitWaypoint-response.msg.html

(cl:defclass <MoveitWaypoint-response> (roslisp-msg-protocol:ros-message)
  ((completed
    :reader completed
    :initarg :completed
    :type cl:boolean
...
(cl:defclass MoveitWaypoint-response (<MoveitWaypoint-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MoveitWaypoint-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MoveitWaypoint-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bwi_moveit_utils-srv:<MoveitWaypoint-response> is deprecated: use bwi_moveit_utils-srv:MoveitWaypoint-response instead.")))

(cl:ensure-generic-function 'completed-val :lambda-list '(m))
(cl:defmethod completed-val ((m <MoveitWaypoint-response>))
  ...
  (completed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MoveitWaypoint-response>) ostream)
  "Serializes a message object of type '<MoveitWaypoint-response>"
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'completed) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MoveitWaypoint-response>) istream)
  "Deserializes a message object of type '<MoveitWaypoint-response>"
    (cl:setf (cl:slot-value msg 'completed) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveitWaypoint-response>)))
  "Returns string type for a service object of type '<MoveitWaypoint-response>"
  "bwi_moveit_utils/MoveitWaypointResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveitWaypoint-response)))
  "Returns string type for a service object of type 'MoveitWaypoint-response"
  "bwi_moveit_utils/MoveitWaypointResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoveitWaypoint-response>)))
  "Returns md5sum for a message object of type '<MoveitWaypoint-response>"
  "f8932f0bdb65419ee0fbaf236c79a04f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoveitWaypoint-response)))
  "Returns md5sum for a message object of type 'MoveitWaypoint-response"
  "f8932f0bdb65419ee0fbaf236c79a04f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoveitWaypoint-response>)))
  "Returns full string definition for message of type '<MoveitWaypoint-response>"
  (cl:format cl:nil "bool completed~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoveitWaypoint-response)))
  "Returns full string definition for message of type 'MoveitWaypoint-response"
  (cl:format cl:nil "bool completed~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MoveitWaypoint-response>))
  (cl:+ 0
     1
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MoveitWaypoint-response>))
  "Converts a ROS message object to a list"
  (cl:list 'MoveitWaypoint-response
    (cl:cons ':completed (completed msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'MoveitWaypoint)))
  'MoveitWaypoint-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'MoveitWaypoint)))
  'MoveitWaypoint-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveitWaypoint)))
  "Returns string type for a service object of type '<MoveitWaypoint>"
  "bwi_moveit_utils/MoveitWaypoint")