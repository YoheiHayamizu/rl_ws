...
"""autogenerated by genpy from bwi_moveit_utils/MoveitCartesianPoseRequest.msg. Do not edit."""
import sys
...
class MoveitCartesianPoseRequest(genpy.Message):
  _md5sum = "1cbbb41448cdd437ba0d9df8e0c7074a"
  _type = "bwi_moveit_utils/MoveitCartesianPoseRequest"
...
"""
  ...
  _slot_types = ['geometry_msgs/PoseStamped','moveit_msgs/CollisionObject[]','moveit_msgs/Constraints']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveitCartesianPoseRequest, self).__init__(*args, **kwds)
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bwi_moveit_utils/MoveitCartesianPoseResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class MoveitCartesianPoseResponse(genpy.Message):
  _md5sum = "9e58faa17a4877a1efc0e251b503c53b"
  _type = "bwi_moveit_utils/MoveitCartesianPoseResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveitCartesianPoseResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class MoveitCartesianPose(object):
  _type          = 'bwi_moveit_utils/MoveitCartesianPose'
  _md5sum = '48463013f77cb96c218a8c43048e406b'
  _request_class  = MoveitCartesianPoseRequest
  _response_class = MoveitCartesianPoseResponse
