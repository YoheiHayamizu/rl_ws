...
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/GoToLocation.srv" NAME_WE)
add_custom_target(_bwi_services_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bwi_services" "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/GoToLocation.srv" ""
)

get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/DeliverMessage.srv" NAME_WE)
add_custom_target(_bwi_services_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bwi_services" "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/DeliverMessage.srv" ""
)

get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/SpeakMessage.srv" NAME_WE)
add_custom_target(_bwi_services_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bwi_services" "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/SpeakMessage.srv" ""
)
...
### Generating Services
_generate_srv_eus(bwi_services
  "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/GoToLocation.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bwi_services
)
_generate_srv_eus(bwi_services
  "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/DeliverMessage.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_eus(bwi_services
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bwi_services
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(bwi_services_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(bwi_services_generate_messages bwi_services_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/GoToLocation.srv" NAME_WE)
add_dependencies(bwi_services_generate_messages_eus _bwi_services_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/DeliverMessage.srv" NAME_WE)
add_dependencies(bwi_services_generate_messages_eus _bwi_services_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/SpeakMessage.srv" NAME_WE)
add_dependencies(bwi_services_generate_messages_eus _bwi_services_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(bwi_services_geneus)
add_dependencies(bwi_services_geneus bwi_services_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS bwi_services_generate_messages_eus)
...
### Generating Services
_generate_srv_nodejs(bwi_services
  "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/GoToLocation.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bwi_services
)
_generate_srv_nodejs(bwi_services
  "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/DeliverMessage.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_nodejs(bwi_services
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bwi_services
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(bwi_services_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(bwi_services_generate_messages bwi_services_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/GoToLocation.srv" NAME_WE)
add_dependencies(bwi_services_generate_messages_nodejs _bwi_services_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/DeliverMessage.srv" NAME_WE)
add_dependencies(bwi_services_generate_messages_nodejs _bwi_services_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/yohei/rl_ws/src/bwi_common/bwi_services/srv/SpeakMessage.srv" NAME_WE)
add_dependencies(bwi_services_generate_messages_nodejs _bwi_services_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(bwi_services_gennodejs)
add_dependencies(bwi_services_gennodejs bwi_services_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS bwi_services_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bwi_services)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bwi_services
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(bwi_services_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bwi_services)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bwi_services
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(bwi_services_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
